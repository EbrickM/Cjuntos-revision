...
import { Search, Eye, Building2, Mail, Phone, ChevronDown } from 'lucide-react';
import AppShell from '../../components/layout/AppShell';
import Button from '../../components/ui/Button';
import Modal from '../../components/ui/Modal';
import InfoRow from '../../components/ui/InfoRow';
import { BANCO, EMPRESAS_CONTRATANTES } from './fondeadorShared';

// ── CLIENTES (portal Banco Fondeador) ──────────────────────────────────────────
// Directorio de Empresas Contratantes registradas en la plataforma (como el de
// /admin/empresas, solo tabla — rol de solo lectura).
...
export default function FondClientes() {
  ...
  return (
    <AppShell active="fondClientes" role="fondeador" title="Clientes" sub={`Directorio de Empresas Contratantes de ${BANCO}`}>
