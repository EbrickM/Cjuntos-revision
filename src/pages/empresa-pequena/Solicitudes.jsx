...
const misSolicitudes = [
  {
    ...
    desc: "Financiamiento capital de trabajo — Q3 2026",
    monto: 25_000_000,
    fecha: "08/07/2026",
    estado: "En revisión",
  },
...
const invitaciones = [
  {
    id: "INV-2026-0034",
    ini: "TE",
    empresa: "TotalEnergies GE",
    sector: "Energía",
    desc: "Suministro de equipos técnicos — contrato marco 2026",
    monto: 120_000_000,
    fecha: "10/07/2026",
  },
  {
    id: "INV-2026-0031",
    ini: "CG",
    empresa: "ConsGroup GE S.A.",
    sector: "Construcción",
    desc: "Obras de mantenimiento de infraestructura portuaria — Bata",
    monto: 85_000_000,
    fecha: "06/07/2026",
  },
  {
    id: "INV-2026-0028",
    ini: "AG",
    empresa: "GEOMS International",
    sector: "Agroindustria",
    desc: "Provisión de insumos agrícolas — campaña 2026/2027",
    monto: 45_000_000,
    fecha: "02/07/2026",
  },
];
...
const IniAvatar = ({ ini, size = 36 }) => (
  <div
    style={{
      ...
      borderRadius: 9,
      flexShrink: 0,
      background: `linear-gradient(135deg, ${ERR}, ${ORA})`,
      display: "flex",
      alignItems: "center",
...
export default function EpSolicitudes() {
  ...
  const {
    visibleItems: pagedMisSolicitudes,
    hasMore: hasMoreMis,
    loading: loadingMis,
    sentinelRef: sentinelMisRef,
  } = useInfiniteScroll(misSolicitudes, { pageSize: 10, delay: 0 });
  const {
    visibleItems: pagedInvitaciones,
    hasMore: hasMoreInv,
    loading: loadingInv,
    sentinelRef: sentinelInvRef,
  } = useInfiniteScroll(invitaciones, { pageSize: 10, delay: 0 });
  ...
  const timelineSteps = (s) => {
    ...
    return [
      ...
      {
        lbl: "En revisión",
        done: isAprobada || isRechazada,
        active: s.estado === "En revisión",
        isResult: false,
        isRechazada: false,
      },
      {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {pagedMisSolicitudes.map((s) => {
              ...
              return (
                <div
                  key={s.id}
                  className="card-lift card-enter bg-white rounded-[14px] border border-border p-5 flex flex-col gap-3"
                >
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-border mt-auto">
                    <div>
                      <p className="text-[16px] font-extrabold text-text-1 leading-none">
                        {fmt(s.monto)}
                      </p>
                      <p
                    ...
                    <button
                      onClick={() => setSolModal(s)}
                      className="text-[11px] font-semibold flex items-center gap-0.5 hover:opacity-75 transition cursor-pointer"
                      style={{ color: ORA }}
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {pagedInvitaciones.map((s) => (
                ...
                >
                  ...
                  <p className="text-[12px] text-text-3 leading-snug flex-1">
                    {s.desc}
                  </p>
                  <div className="flex items-center justify-between pt-3 border-t border-border">
                    <div>
                      <p className="text-[18px] font-extrabold text-text-1 leading-none">
                        {fmt(s.monto)}
                      </p>
                      <p
                        className="text-[10px] mt-0.5"
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="sm:col-span-2">
                    <InfoRow label="Descripción" value={s.desc} />
                  </div>
                ...
                {/* Timeline */}
                <div>
                  <p className="text-[10px] font-semibold text-text-4 uppercase tracking-wide mb-4">
                    Estado del proceso
                  </p>
                          ...
                          <div className="flex items-center w-full">
                            <div
                              ...
                              style={{
                                ...
                                background: step.done ? dotColor : "white",
                              }}
                            >
                ...
                {s.estado === "Rechazada" && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[11px] mt-0.5" style={{ color: ERR }}>
                        No fue posible aprobar esta solicitud en este momento.
                        Para más información, contacta con tu gestor en
                        Bonafide.
                      </p>
                    </div>
                  </div>
