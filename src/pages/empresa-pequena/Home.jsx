import {
  Briefcase, Wallet, Users, Receipt,
  Unlock, FileText, AlertTriangle,
  DollarSign, Hammer, HardHat, CheckCircle2,
} from 'lucide-react';
...
const kpis = [
  { Icon: Briefcase, bg: 'bg-orange-tint', val: '2',         valCls: 'text-orange',     lbl: 'Préstamos Activos',       sub: '1 pendiente aprobación',      trend: '↑ +1 nuevo',       trendCls: 'bg-green-bg text-green-text',   to: 'epPrestamos' },
...
const acciones = [
  { Icon: Briefcase, lbl: 'Nuevo Préstamo',  id: 'epSolicitar' },
  { Icon: Unlock,    lbl: 'Liberar Fondos',  id: 'epLiberacion' },
    ...
    >
      <div className="fade-in">
        ...
        <div className="bg-yellow-bg border border-yellow/40 rounded-[14px] p-4 flex items-center gap-3">
          <AlertTriangle className="w-5 h-5 text-yellow-text shrink-0" />
...
function CheckCircle2Icon() {
  return <CheckCircle2 className="w-3.5 h-3.5 inline mr-1" />;
}
