          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                { value: '3.200 t',                               label: 'Captura CO₂',       tone: 'gradient' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-[14px] border border-border p-5 flex flex-col gap-4">
                <div className="flex items-center justify-between gap-3 flex-wrap">
                  <div className="flex items-center gap-2.5">
                    <div className="w-9 h-9 rounded-[10px] flex items-center justify-center shrink-0" style={{ background: '#FFFBEB', border: '1px solid #FDE68A' }}>
                      <Users className="w-5 h-5" style={{ color: '#C68A1D' }} />
                    </div>
                    <div>
                  ...
                  <span className="text-[10px] font-bold px-2 py-1 rounded-full whitespace-nowrap shrink-0"
                    style={{ background: '#FFFBEB', color: '#C68A1D', border: '1px solid #FDE68A' }}>
