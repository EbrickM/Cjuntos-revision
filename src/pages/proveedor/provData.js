...
// ── Datos ─────────────────────────────────────────────────────────────────────
// Identidad del Proveedor logueado en este dashboard: APEX, ya
...
export const contratos = [
  { id: 'CT-2026-0081', pyme: 'Martinez Hermanos (MH)', ini: 'MH', sector: 'Transporte', asignado: 22_000_000, utilizado: 9_500_000, facturas: 1, estado: 'Activo',
  ...
  { id: 'CT-2026-0088', pyme: 'Tradex', ini: 'TR', sector: 'Transporte', asignado: 9_000_000, utilizado: 4_500_000, facturas: 1, estado: 'Con Requerimientos',
...
export const facturas = [
  { id: 'FAC-2026-2101', contrato: 'CT-2026-0081', suministrador: 'SAP', monto: 9_500_000, fecha: '30/06/2026', estado: 'Recibida', concepto: 'Suministro de combustible para flota de transporte — junio 2026' },
  { id: 'FAC-2026-2108', contrato: 'CT-2026-0088', suministrador: 'Lideshore',    monto: 4_500_000, fecha: '08/07/2026', estado: 'Recibida', concepto: 'Repuestos y mantenimiento de unidades de transporte' },
];

// Directorio de Suministradores (equivalente a `pymes` en contratanteData.js).
export const suministradores = [
  { ini: 'SP', nombre: 'SAP', sector: 'Energía', contratos: 1, montoTotal: 9_500_000, score: 705, semaforo: 'Verde',
  ...
  { ini: 'LI', nombre: 'Lideshore', sector: 'Comercio', contratos: 1, montoTotal: 4_500_000, score: 640, semaforo: 'Amarillo',
...
export const misSolicitudes = [
  { id: 'SOL-2026-0201', tipo: 'Nuevo contrato', desc: 'Contrato con Lideshore · Comercio', monto: 15_000_000, fecha: '05/07/2026', estado: 'En revisión' },
];

export const solicitudesSuministradores = [
  { id: 'SOLS-2026-0071', ini: 'TC', pyme: 'Conexxia Tech', sector: 'Tecnología',  desc: 'Mantenimiento de sistemas de rastreo GPS para la flota', monto: 12_000_000, fecha: '02/07/2026' },
  { id: 'SOLS-2026-0068', ini: 'AP', pyme: 'APEX Logística', sector: 'Transporte', desc: 'Alquiler de vehículos de carga pesada — campaña 2026',   monto: 18_000_000, fecha: '28/06/2026' },
];
