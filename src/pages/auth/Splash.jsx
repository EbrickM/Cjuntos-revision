...
export default function Splash() {
  ...
  return (
    ...
    >
      <div className="w-20 h-20 bg-gradient-to-br from-orange to-orange-dark rounded-[20px] flex items-center justify-center mb-5 shadow-[0_8px_24px_rgba(232,82,26,.3)]">
