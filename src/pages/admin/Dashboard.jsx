      ...
      <div className="fade-in space-y-5">
        ...
        {tab === 'general' && (
          <div key="general" className="fade-in space-y-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
              ...
              {/* LineChart 3/5 */}
              <div className="lg:col-span-3 bg-white rounded-[14px] border border-border p-5 flex flex-col transition-all duration-200 hover:scale-[1.02] hover:shadow-[0_10px_32px_rgba(224,32,28,0.18),0_4px_14px_rgba(239,122,44,0.12)]">
              ...
              {/* DonutChart 2/5 */}
              <div className="lg:col-span-2 bg-white rounded-[14px] border border-border p-5 flex flex-col transition-all duration-200 hover:scale-[1.02] hover:shadow-[0_10px_32px_rgba(224,32,28,0.18),0_4px_14px_rgba(239,122,44,0.12)]">
                <div className="mb-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
              ...
              {/* Table 3/5 */}
              <div className="lg:col-span-3 bg-white rounded-[14px] border border-border p-5 transition-all duration-200 hover:scale-[1.02] hover:shadow-[0_10px_32px_rgba(224,32,28,0.18),0_4px_14px_rgba(239,122,44,0.12)]">
        ...
        {tab === 'riesgo' && (
          <div key="riesgo" className="fade-in space-y-5">
            ...
            <div className="bg-white rounded-[14px] border border-border p-5 transition-all duration-200 hover:scale-[1.02] hover:shadow-[0_10px_32px_rgba(224,32,28,0.18),0_4px_14px_rgba(239,122,44,0.12)]">
