          ...
          >
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                <div className="col-span-2"><InfoRow label="Descripción" value={s.desc} /></div>
...
export function EmpNuevaSolicitud() {
  const { go } = useApp();
  const [sol]  = useState(() => { const v = _solicitudPyme; _solicitudPyme = null; return v; });
