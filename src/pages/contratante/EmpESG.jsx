...
const SOCIAL_METAS = [
  ...
  { label: 'Educación y formación',  pct: 71, color: '#EF7A2C' },
                ...
                right={
                  <div className="flex items-center gap-3 shrink-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[11px] font-bold whitespace-nowrap text-orange">3.090 beneficiarios</span>
                    </div>
        ...
        >
          <div className="mb-5">
            ...
            <FormGroup label="Nombre de la iniciativa" required>
              <Input
                placeholder="Ej. Centro de formación técnica Malabo"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
              ...
              <FormGroup label="Beneficiarios estimados">
                <Input placeholder="Ej. 500" value={socialForm.beneficiarios} onChange={setSocial('beneficiarios')} />
              </FormGroup>
              <FormGroup label="Inversión (XAF)">
                <Input placeholder="Ej. 45000000" value={socialForm.inversion} onChange={setSocial('inversion')} />
              </FormGroup>
              <FormGroup label="Estado inicial">
